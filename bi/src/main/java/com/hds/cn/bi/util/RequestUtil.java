...
public class RequestUtil {
	...
	public static Map<String, Object> ckResUtil(JSONObject json) {
		Map<String, Object> requestMap = new HashMap<String, Object>();
		...
		if (null != json.get("startDate") && null != json.get("endDate") && json.get("startDate").equals(json.get("endDate"))) {
			requestMap.put("type", "hour");
		} else {
			requestMap.put("type", "day");
		}
		
		if(null != json.get("agentType")) { 
