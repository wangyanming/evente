...
public class AESUtils {
	...
	public static void main(String[] args) {
		...
		//System.out.println(new BigDecimal(se.AESDncode("eventmosh", "/MfPnxPqFR/q+7IR/S5+WFxxg6ulV4hAUP8qKydarCc=")));
		
		//System.out.println(se.AESDncode("eventmosh", "FqYkaayFYFQXYmGOYZpLBJifM/ak8DA2XAtYdZni1NiMqhmOlsy63Qux59JE78W0"));
	}
}
